public class BarszczSosnowskiego extends Roslina {
    ...
    public BarszczSosnowskiego(int pozX, int pozY, Swiat swiat, int wiek, boolean zyje) {
        super(10, 0, pozX, pozY, swiat, 'B', wiek, zyje);
    }

    public BarszczSosnowskiego(int sila, int inicjatywa, int pozX, int pozY, Swiat swiat, char symbol, int wiek, boolean zyje) {
